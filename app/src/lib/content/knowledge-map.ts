...
export const KNOWLEDGE_CARDS: KnowledgeCard[] = [
  ...
  {
    id: 'heart-anatomy-01',
    section: 'heart', subsection: 'anatomy', priority: 'P0',
    phase: ['adaptation', 'improvement', 'maintenance'],
    audience: ['general'],
    title: '心脏的结构与工作原理',
    body: '心脏是一个约拳头大小的肌肉器官，位于胸腔中央偏左。它由三大系统协同工作：泵血系统由4个腔室和4个瓣膜组成——右心房和右心室接收来自全身的血液并泵往肺部；左心房和左心室接收含氧血液再泵往全身；三尖瓣、肺动脉瓣、二尖瓣和主动脉瓣像单向门，确保血液只朝一个方向流动。电传导系统由窦房结发出电信号，触发心肌收缩，您每次测脉搏感受到的就是这个节律。供血系统由冠状动脉组成，专门为心肌本身提供血液和氧气。了解这三个系统，有助于理解医生的检查结果（如心电图、心超），以及治疗（如支架或搭桥手术）究竟是在解决什么问题。',
  },
  {
    id: 'heart-cad-01',
    section: 'heart', subsection: 'mechanism', priority: 'P0',
    phase: ['adaptation', 'improvement'],
    audience: ['general'],
    title: '斑块是如何堵塞血管的',
    body: '冠状动脉是专门为心肌供血的血管，共有4条主要分支。冠心病的核心机制是动脉内壁斑块的累积：脂肪、胆固醇和钙质随时间沉积在管壁，使血管变窄，导致心肌供血不足——这是心绞痛的根源。斑块从童年就可能开始积累，吸烟、高血压、高血脂、高血糖等危险因素会显著加速这一过程。当斑块突然破裂，在破裂处形成血栓并完全堵塞动脉时，就会发生心肌梗死（心脏病发作）。PCI支架手术和CABG搭桥手术是恢复血流的两种主要方式，但它们并不能消除已有的斑块体质——这正是术后必须长期坚持二级预防用药和生活方式改变的根本原因。',
  },
  ...
  {
    id: 'psych-depression-01',
    section: 'psych', subsection: 'depression', priority: 'P0',
    phase: ['adaptation', 'improvement'],
    audience: ['general'],
    title: '抑郁与心脏病：不是软弱，是并发症',
    body: '心脏病后出现抑郁，不是意志力的问题，而是一种有医学依据的并发症。如果您在过去两周内持续出现以下情况，请认真对待：失去对曾经喜欢的事物的兴趣、持续感到绝望或悲伤、能量极低、睡眠明显改变、难以集中注意力，或对自己有负面想法——这些是抑郁症的症状，而不只是"低落情绪"。抑郁对心脏的影响是直接的：它会使血液更容易凝固（增加血栓风险）、升高皮质醇等压力荷尔蒙水平、增加心律不齐的可能性，同时还会降低患者坚持服药和参与康复的意愿。有效的治疗方式包括心理辅导、规律运动和必要时的药物治疗。如果您有上述症状，请告知医生——主动寻求帮助是康复的一部分。',
  },
  {
    id: 'psych-stress-01',
    section: 'psych', subsection: 'stress', priority: 'P0',
    phase: ['adaptation', 'improvement', 'maintenance'],
    audience: ['general'],
    title: '压力为什么会直接伤害心脏',
    body: '压力不只是一种感受，它会触发身体的生理反应，对心脏产生实际伤害。压力状态下，身体会释放肾上腺素和皮质醇，使心率和血压升高、血液变得更黏稠（更容易凝固）、血管中的斑块更容易聚集。短期急性压力（如剧烈情绪激动）可以直接诱发心绞痛或心脏事件；长期慢性压力（如持续的工作、财务或家庭压力）则会持续激活这些机制，研究证实它会显著增加心脏病发作的概率。管理压力是可以学习的技能，有效方法包括：腹式呼吸（用横膈膜深呼吸，每次5-10分钟）、渐进式肌肉放松、冥想或正念练习、保持社交联系。规律运动本身也是最有效的减压工具之一。如果感觉压力持续无法缓解，向心理咨询师或社会工作者寻求帮助是完全合理的选择。',
  },
  {
    id: 'psych-sleep-01',
    section: 'psych', subsection: 'sleep', priority: 'P0',
    phase: ['adaptation', 'improvement', 'maintenance'],
    audience: ['general'],
    title: '睡眠不佳会加重心脏负担',
    body: '心血管系统需要夜间睡眠完成"修复和恢复"——这不是可以妥协的建议，而是医学事实。睡眠不足会导致血糖和胰岛素水平紊乱、血压升高（心血管系统无法充分休息），同时升高压力荷尔蒙水平，加速血管内斑块的形成。有一种常被忽视的情况值得注意：睡眠呼吸暂停（睡觉时频繁短暂停止呼吸）。它会导致血氧浓度降低、夜间血压飙升，显著增加心脏事件风险。常见迹象是大声打鼾、白天极度疲惫，或有人发现您睡觉时停止呼吸——如果有这些情况，请告知医生进行睡眠评估。改善睡眠的实用方法：保持固定的睡眠时间；睡前1小时减少屏幕使用；睡前4小时避免咖啡因和酒精；保持卧室凉爽、安静、黑暗；建立放松的就寝习惯（如阅读或轻柔音乐）。',
  },
